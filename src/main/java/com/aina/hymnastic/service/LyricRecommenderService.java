...
public class LyricRecommenderService {
    ...
    public static void main(String[] args) {
        ...
        String lyric = "all i wanna do is";
        int numRecommendations = 5;

        try {
            // Build the command to execute the Python script
            ProcessBuilder processBuilder = new ProcessBuilder("python", pythonScriptPath, lyric, String.valueOf(numRecommendations));
